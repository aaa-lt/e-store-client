          ...
          <div class="space-y-4">
            ...
            <div class="px-6 sm:px-0 max-w-sm">
              <button
                ...
                class="text-white w-full bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between mr-2 mb-2"
              >
                <svg
